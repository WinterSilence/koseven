...
class KO7_Cache_File extends Cache implements Cache_GarbageCollect
{
    ...
    public function get($id, $default = null)
    {
        ...
        try {
            ...
            if ($e->getCode() === E_NOTICE) {
                throw new Cache_Exception(
                    __METHOD__ . ' failed to unserialize cached object with message : ' . $e->getMessage()
                );
            }
    ...
    public function set($id, $data, $lifetime = null)
    {
        ...
        try {
            ...
            if ($e->getCode() === E_NOTICE) {
                ...
                throw new Cache_Exception(
                    __METHOD__ . ' failed to serialize data for caching with message : ' . $e->getMessage()
                );
            }
        ...
        try {
            ...
            if ($file->isFile()) {
                try {
                    ...
                    if ($e->getCode() === E_WARNING) {
                        throw new Cache_Exception(
                            __METHOD__ . ' failed to delete file : :file',
            ...
            elseif ($file->isDir()) {
                ...
                try {
                    ...
                    if ($e->getCode() === E_WARNING) {
                        throw new Cache_Exception(
                            __METHOD__ . ' failed to delete directory : :directory',
    ...
    protected function _resolve_directory($filename)
    {
        return $this->_cache_dir->getRealPath(
            ) . DIRECTORY_SEPARATOR . $filename[0] . $filename[1] . DIRECTORY_SEPARATOR;
    }
