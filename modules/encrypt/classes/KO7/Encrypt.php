    ...
    public function __construct(string $name, array $config)
    {
        ...
        if (! class_exists($engine_name)) {
            throw new KO7_Exception(
                'Encryption type: :name defined in the encryption configuratin does not exist.', [
                ':name' => $engine_name,
            ]
            );
        }
        ...
        if (! $this->_engine instanceof KO7_Encrypt_Engine) {
            ...
            throw new KO7_Exception(
                'Encryption type: :name defined in the encryption configuration is not a valid type/driver class.', [
                ':name' => $engine_name,
            ]
            );
