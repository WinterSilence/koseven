 ...
 */
abstract class KO7_Encrypt_Engine
{
    ...
    protected function valid_key_length($expected)
    {
        ...
        if ($length !== $expected) {
            throw new KO7_Exception(
                'No valid encryption key is defined in the encryption configuration: length should be :required_length for :cipher, is: :current_length',
                [
                    ':cipher' => $this->_cipher,
