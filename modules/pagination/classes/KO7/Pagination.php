...
class KO7_Pagination
{
    ...
    public function setup(array $config = [])
    {
        ...
        if ($this->current_page === null
            ...
            $this->current_first_item = (int) min(
                (($this->current_page - 1) * $this->items_per_page) + 1,
                $this->total_items
            );
            $this->current_last_item = (int) min(
                $this->current_first_item + $this->items_per_page - 1,
                $this->total_items
            );
     ...
     *
     * @param mixed   string of the view to use, or a KO7_View object
