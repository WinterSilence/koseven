...
<div id="kohana_error">
    <h1><span class="type"><?php
            ...
            echo htmlspecialchars((string) $message, ENT_QUOTES | ENT_IGNORE, KO7::$charset, true); ?></span></h1>
    <div id="<?php
            ...
            foreach (Debug::trace($trace) as $i => $step): ?>
                <li>
					...
					<span class="file">
                        ...
                        if ($step['args']): $args_id = $error_id . 'args' . $i; ?><a href="#<?php
                        echo $args_id ?>" onclick="return koggle('<?php
                        echo $args_id ?>')"><?php
                            echo I18n::get('arguments') ?></a><?php
                        endif ?>)
                    </p>
                    <?php
                    if (isset($args_id)): ?>
    ...
    <h2><a href="#<?php
        ...
        echo $env_id ?>')"><?php
            echo I18n::get('Environment') ?></a></h2>
    <div id="<?php
    echo $env_id ?>" class="content collapsed">
        ...
        <h3><a href="#<?php
            ...
            echo $env_id ?>')"><?php
                echo I18n::get('Included files') ?></a> (<?php
        ...
        <h3><a href="#<?php
            ...
            echo $env_id ?>')"><?php
                echo I18n::get('Loaded extensions') ?></a> (<?php
            echo count($included) ?>)</h3>
        <div id="<?php
        echo $env_id ?>" class="collapsed">
            <table cellspacing="0">
