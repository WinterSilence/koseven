...
abstract class KO7_Controller_Userguide extends Controller_Template
{
    ...
    public function error($message)
    {
        ...
        if ($module = $this->request->param('module') and $menu = $this->file($module . '/menu') and KO7::$config->load(
                'userguide.modules.' . $module . '.enabled'
            )) {
            ...
            $this->template->breadcrumb = [
                ...
                $this->guide->uri(['module' => $module]) => KO7::$config->load(
                    'userguide.modules.' . $module . '.name'
                ),
                'Error',
            ];
    ...
    public function action_docs()
    {
        ...
        $breadcrumb[$this->guide->uri(['module' => $module])] = KO7::$config->load(
            'userguide.modules.' . $module . '.name'
        );
