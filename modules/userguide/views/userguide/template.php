...
<head>
    ...
    <title><?php
        echo $title ?> | Koseven <?php
        echo 'User Guide'; ?></title>
        ...
        <div id="kodoc-menu">
            <ul>
                <li class="guide first">
                    <a href="<?php
                    echo Route::url('docs/guide') ?>">User Guide</a>
                </li>
                <?php
                if (KO7::$config->load('userguide.api_browser')): ?>
                    <li class="api">
                        <a href="<?php
                        echo Route::url('docs/api') ?>">API Browser</a>
                    </li>
                <?php
                endif ?>
            </ul>
                ...
                <div class="span-22 prefix-1 suffix-1">
                    <ul id="kodoc-breadcrumb">
                        ...
                        foreach ($breadcrumb as $link => $title): ?>
                            ...
                            if (is_string($link)): ?>
                                <li><?php
                                    echo HTML::anchor($link, $title, null, null, true) ?></li>
                            <?php
                            else: ?>
                                <li class="last"><?php
                                    echo $title ?></li>
            ...
            <div id="kodoc-body" class="span-16 suffix-1 last">
                ...
                if ($show_comments): ?>
                    ...
                    <script type="text/javascript">
                        ...
                        echo HTML::chars(Request::current()->uri()) ?>';
						(function() {
                    ...
                    <noscript>Please enable JavaScript to view the <a href="http://disqus.com/?ref_noscript=koseven">comments
                            powered by Disqus.</a></noscript>
                    <a href="http://disqus.com" class="dsq-brlink">Documentation comments powered by <span
...
<div id="kodoc-footer">
    <div class="container">
        ...
        <div class="span-12 last right">
            <p>Powered by <?php
                echo HTML::anchor('https://koseven.dev/', 'Koseven') ?> v<?php
                echo KO7::VERSION ?></p>
        </div>
    </div>
</div>
