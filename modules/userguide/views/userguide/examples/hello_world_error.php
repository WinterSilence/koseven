...
<div id="koseven_error">
    <h1><span class="type">KO7_View_Exception [ 0 ]:</span> <span class="message">The requested view site could not be found</span>
    </h1>
        ...
        <ol class="trace">
            <li>
                <p>
					...
					<span class="file">
													<a href="#error4ac2453378034source0"
                                                       onclick="return koggle('error4ac2453378034source0')">SYSPATH/classes/ko7/view.php [ 115 ]</a>
											</span>
                    &raquo;
                    KO7_View->set_filename(<a href="#error4ac2453378034args0"
                                              onclick="return koggle('error4ac2453378034args0')">arguments</a>)
                </p>
                <div id="error4ac2453378034args0" class="collapsed">
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <pre><small>string</small><span>(4)</span> "site"</pre>
                            </td>
                        </tr>
                    </table>
                </div>

                <pre id="error4ac2453378034source0" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">110</span> 	 */
            ...
            <li>
                <p>
					<span class="file">
													<a href="#error4ac2453378034source1"
                                                       onclick="return koggle('error4ac2453378034source1')">SYSPATH/classes/ko7/view.php [ 26 ]</a>
											</span>
                    &raquo;
                    KO7_View->__construct(<a href="#error4ac2453378034args1"
                                             onclick="return koggle('error4ac2453378034args1')">arguments</a>)
                </p>
                ...
                <div id="error4ac2453378034args1" class="collapsed">
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <pre><small>NULL</small></pre>
                            </td>
                        </tr>
                    </table>
                </div>
                <pre id="error4ac2453378034source1" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">21</span> 	 * @param   array   array of values
            ...
            <li>
                <p>
					...
					<span class="file">
													<a href="#error4ac2453378034source2"
                                                       onclick="return koggle('error4ac2453378034source2')">SYSPATH/classes/ko7/controller/template.php [ 32 ]</a>
											</span>
                    &raquo;
                    KO7_View::factory(<a href="#error4ac2453378034args2"
                                         onclick="return koggle('error4ac2453378034args2')">arguments</a>)
                </p>
                ...
                <pre id="error4ac2453378034source2" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">27</span> 	public function before()
</span><span class="line"><span class="number">28</span> 	{
            ...
            <li>
                <p>
					<span class="file">
													<a href="#error4ac2453378034source4"
                                                       onclick="return koggle('error4ac2453378034source4')">SYSPATH/classes/ko7/request.php [ 840 ]</a>
											</span>
                    &raquo;
                    ReflectionMethod->invoke(<a href="#error4ac2453378034args4"
                                                onclick="return koggle('error4ac2453378034args4')">arguments</a>)
                </p>
    ...
    <small>public</small> request => <small>object</small> <span>Request(9)</span> <code>{
        ...
        <small>protected</small> _params => <small>array</small><span>(0)</span>
                ...
                <pre id="error4ac2453378034source4" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">835</span>
            ...
            <li>
                <p>
					<span class="file">
													<a href="#error4ac2453378034source5"
                                                       onclick="return koggle('error4ac2453378034source5')">APPPATH/bootstrap.php [ 76 ]</a>

											</span>
                    &raquo;
                    KO7_Request->execute()
                </p>
                <pre id="error4ac2453378034source5" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">71</span> /**
            ...
            <li>
                <p>
					<span class="file">
													<a href="#error4ac2453378034source6"
                                                       onclick="return koggle('error4ac2453378034source6')">DOCROOT/index.php [ 106 ]</a>
											</span>
                    &raquo;
                ...
                <div id="error4ac2453378034args6" class="collapsed">
                    <table cellspacing="0">
                        <tr>
                            <td><code>0</code></td>
                            <td>
                                <pre><small>string</small><span>(49)</span> "/var/www/ko7/testing/application/bootstrap.php"</pre>
                            </td>
                        </tr>

                    </table>
                </div>
                <pre id="error4ac2453378034source6" class="source collapsed"><code><pre class="source"><code><span
                                    class="line"><span class="number">101</span> 	// Load empty core extension
    ...
    <h2><a href="#error4ac2453378034environment"
           onclick="return koggle('error4ac2453378034environment')">Environment</a></h2>
    <div id="error4ac2453378034environment" class="content collapsed">
        <h3><a href="#error4ac2453378034environment_included"
               onclick="return koggle('error4ac2453378034environment_included')">Included files</a> (31)</h3>
        ...
        <h3><a href="#error4ac2453378034environment_loaded"
               onclick="return koggle('error4ac2453378034environment_loaded')">Loaded extensions</a> (41)</h3>
        ...
        <h3><a href="#error4ac2453378034environment_server"
               onclick="return koggle('error4ac2453378034environment_server')">$_SERVER</a></h3>
        <div id="error4ac2453378034environment_server" class="collapsed">
            ...
            <table cellspacing="0">
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(9)</span> "localhost"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(105)</span> "Mozilla/5.0 (X11; U; Linux i686; en-GB; rv:1.9.0.14) Gecko/2009090216 Ubuntu/9.04 (jaunty) Firefox/3.0.14"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>HTTP_ACCEPT</code></td>
                    <td>
                        <pre><small>string</small><span>(63)</span> "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(14)</span> "en-gb,en;q=0.5"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(12)</span> "gzip,deflate"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>HTTP_ACCEPT_CHARSET</code></td>
                    <td>
                        <pre><small>string</small><span>(30)</span> "ISO-8859-1,utf-8;q=0.7,*;q=0.7"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(3)</span> "300"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(10)</span> "keep-alive"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>PATH</code></td>
                    <td>
                        <pre><small>string</small><span>(28)</span> "/usr/local/bin:/usr/bin:/bin"</pre>
                    </td>
...
"</pre>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(62)</span> "Apache/2.2.11 (Ubuntu) PHP/5.2.6-3ubuntu4.2 with Suhosin-Patch"</pre>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(3)</span> "::1"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(2)</span> "80"</pre>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(8)</span> "/var/www"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(19)</span> "webmaster@localhost"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(33)</span> "/var/www/ko7/testing/index.php"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>REMOTE_PORT</code></td>
                    <td>
                        <pre><small>string</small><span>(5)</span> "39409"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(7)</span> "CGI/1.1"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(8)</span> "HTTP/1.1"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>REQUEST_METHOD</code></td>
                    <td>
                        <pre><small>string</small><span>(3)</span> "GET"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(0)</span> ""</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(31)</span> "/ko7/testing/index.php/hello"</pre>
                    </td>
                </tr>
                <tr>
                    <td><code>SCRIPT_NAME</code></td>
                    <td>
                        <pre><small>string</small><span>(25)</span> "/ko7/testing/index.php"</pre>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(6)</span> "/hello"</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>string</small><span>(14)</span> "/var/www/hello"</pre>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <pre><small>integer</small> 1254245682</pre>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <pre><small>array</small><span>(0)</span> </pre>
                    </td>
                </tr>
                <tr>
                    <td><code>argc</code></td>
                    <td>
                        <pre><small>integer</small> 0</pre>
                    </td>
