...
class Bench_MDDoBaseURL extends Codebench
{
    ...
    public $description = 'Optimization for the <code>doBaseURL()</code> method of <code>KO7_Kodoc_Markdown</code>
