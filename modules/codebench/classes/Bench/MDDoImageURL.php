...
class Bench_MDDoImageURL extends Codebench
{
    ...
    public $description = 'Optimization for the <code>doImageURL()</code> method of <code>KO7_Kodoc_Markdown</code>
