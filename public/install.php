...
<div class="container">
    ...
    <p>
        ...
        have failed, consult the <a href="https://koseven.dev/guide/ko7/install" target="_blank">documentation</a> for
    ...
    <table>
        ...
        <tr>
            ...
            <?php
                ...
                <td class="fail">
                    Koseven requires PHP 7.2 or newer, this version is <?php
                    echo PHP_VERSION ?>.
                </td>
            <?php
            endif ?>
        ...
        <tr>
            ...
            <?php
            if (is_dir(SYSPATH) and is_file(SYSPATH . 'classes/KO7' . EXT)): ?>
                <td class="pass">
                    <?php
                    echo SYSPATH ?>
                </td>
        ...
        <tr>
            ...
            <?php
                ...
                <td class="fail">The <code><?php
                        echo APPPATH . 'cache/' ?></code> directory is not writable.
                </td>
            <?php
            endif ?>
        </tr>
        <tr>
            ...
            <?php
                ...
                <td class="fail">The <code><?php
                        echo APPPATH . 'logs/' ?></code> directory is not writable.
                </td>
            <?php
            endif ?>
        </tr>
        <tr>
            <th>PCRE UTF-8</th>
            <?php
            if (! @preg_match('/^.$/u', 'ñ')): $failed = true ?>
                <td class="fail"><a href="http://php.net/pcre">PCRE</a> has not been compiled with UTF-8 support.</td>
            <?php
            elseif (! @preg_match('/^\pL$/u', 'ñ')): $failed = true ?>
        ...
        if (extension_loaded('mbstring')): ?>
            <tr>
                ...
                <?php
                if (ini_get('mbstring.func_overload') & MB_OVERLOAD_STRING): $failed = true ?>
        ...
        <tr>
            ...
            <?php
            if (! function_exists('ctype_digit')): $failed = true ?>
