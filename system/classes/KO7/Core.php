...
class KO7_Core
{
    ...
    /**
     * @var bool True if KO7 is running on windows
     */
    ...
    /**
     * @var int Default lifetime for caching, in seconds, used by [KO7::cache]. Set by [KO7::init]
     */
    public static $cache_life = 60;

    /**
     * @var bool Whether to use internal caching for [KO7::find_file], does not apply to [KO7::cache]. Set by [KO7::init]
     */
    public static $caching = false;

    /**
     * @var bool Whether to enable [profiling](KO7/profiling). Set by [KO7::init]
     */
    public static $profiling = true;

    /**
     * @var bool Enable KO7 catching and displaying PHP errors and exceptions. Set by [KO7::init]
     */
    ...
    /**
     * @var bool Has [KO7::init] been called?
     */
    ...
    /**
     * @var bool Has the file path cache changed during this execution?  Used internally when when caching is true in [KO7::init]
     */
    ...
    public static function init(array $settings = null)
    {
         ...
         */
        if (KO7::$environment == KO7::DEVELOPMENT && extension_loaded('xdebug')) {
    ...
    public static function find_file($dir, $file, $ext = null, $array = false)
    {
        ...
        if (KO7::$caching === true && isset(KO7::$_files[$path . ($array ? '_array' : '_path')])) {
            // This path has been cached
            return KO7::$_files[$path . ($array ? '_array' : '_path')];
        }

        if (KO7::$profiling === true && class_exists('Profiler', false)) {
     ...
     * @param array|string $ext only list files with this extension
    ...
    public static function shutdown_handler()
    {
        ...
        try {
            if (KO7::$caching === true && KO7::$_files_changed === true) {
        ...
        if (KO7::$errors && $error = error_get_last() && in_array($error['type'], KO7::$shutdown_errors)) {
