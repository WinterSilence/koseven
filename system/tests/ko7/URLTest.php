...
class KO7_URLTest extends Unittest_TestCase
{
    ...
    public function provider_base()
    {
        return [
            ...
            [
                ...
                true,
                null,
                'cli://example.com/ko7/index.php/',
                ['HTTPS' => false, 'Request::$initial' => Request::factory('/')->protocol('cli')],
            ],
    ...
    public function provider_site()
    {
        return [
            ...
            [
                'some/long/route/goes/here?ko7=awesome&life=good#fact',
                null,
                '/ko7/index.php/some/long/route/goes/here?ko7=awesome&life=good#fact',
            ],
            [
                'some/long/route/goes/here?ko7=awesome&life=good#fact',
                'http',
                'http://example.com/ko7/index.php/some/long/route/goes/here?ko7=awesome&life=good#fact',
            ],

            [
                '/route/goes/here?ko7=awesome&life=good#fact',
                'https',
                'https://example.com/ko7/index.php/route/goes/here?ko7=awesome&life=good#fact',
            ],
            [
                '/route/goes/here?ko7=awesome&life=good#fact',
                'ftp',
                'ftp://example.com/ko7/index.php/route/goes/here?ko7=awesome&life=good#fact',
            ],
        ];
    }
